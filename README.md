...
+ **Clear Colors** on nodes to their default colors with <*Ctrl + Shift + C*>
...
+ *Automatically color* groups of Nodes in a trickle down effect or enter edit mode to place nodes with a set color using <*Ctrl + E*>
